/*
 js-mindmap from Kenneth Kufluk
 https://github.com/kennethkufluk/js-mindmap

 Copyright (c) 2008/09/10 Kenneth Kufluk http://kenneth.kufluk.com/ (MIT Licensed)
...
(function ($) {
  ...
  var TIMEOUT = 3,  // movement timeout in seconds
      CENTRE_FORCE = 5,  // strength of attraction to the centre by the active node
      Node,
      Line;
...
//    if (!!this.mindmapInit) return false;
      //remove a node matching the name
//      alert(name+' removed');
    });
  };
